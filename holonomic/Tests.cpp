...
namespace Tests
{
  ...
  void dance()
  {
    ...
    // rotate a bit
    //
    Motors::rotate(distance * -4); Motors::commit();
    Motors::rotate(distance *  4); Motors::commit();
    ...
    Motors::move(0, -1 * distance); Motors::commit();
    ...
    for (angle = 0; angle < 360; angle += 10) {
      ...
      xdistance = (int)(cos(angle_in_radians) * 100.0f);
      ydistance = (int)(sin(angle_in_radians) * 100.0f);
